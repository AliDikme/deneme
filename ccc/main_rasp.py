...
class App:
    ...
    def processTheAuido(self):
        ...
        with sr.AudioFile(filename) as source:
            ...
            text = r.recognize_google(audio_data, "tr")
            normal = text
            print(text)
        ...
        if(isSubstring(command1, normal)):
            ...
            cityText=command1.split(" ")[0]
            tts = gtts.gTTS(f"{cityText} içince Sıcaklık : {data['temp_now']}°C derece", lang="tr")
            # save the audio file
            tts.save("hello.mp3")
            # play the audio file
            # playsound("hello.mp3")
